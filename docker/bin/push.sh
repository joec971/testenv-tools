...
docker login
docker push sifive/clang-riscv64_dbg:@ALPINE_VER@-@SI5_VER@-@NEWLIB_VER@
docker push sifive/clang-riscv32_dbg:@ALPINE_VER@-@SI5_VER@-@NEWLIB_VER@
docker push sifive/clang-riscv32:@ALPINE_VER@-@SI5_VER@-@NEWLIB_VER@
docker push sifive/clang-riscv64:@ALPINE_VER@-@SI5_VER@-@NEWLIB_VER@
