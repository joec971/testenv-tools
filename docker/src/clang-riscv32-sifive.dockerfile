...
# docker build -f clang-riscv32-sifive.dockerfile -t sifive/clang-riscv32:a3.13-r202104-n4.1a .
# if debug:
#  docker build -f clang-riscv32-sifive.dockerfile -t sifive/clang-riscv32_dbg:a3.13-r202104-n4.1a .
