...
# docker build -f clang-riscv32-sifive.dockerfile -t sifive/clang-riscv32:@ALPINE_VER@-@SI5_VER@-@NEWLIB_VER@ .
# if debug:
#  docker build -f clang-riscv32-sifive.dockerfile -t sifive/clang-riscv32_dbg:@ALPINE_VER@-@SI5_VER@-@NEWLIB_VER@ .
