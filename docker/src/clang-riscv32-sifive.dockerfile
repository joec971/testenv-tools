...
# docker build -f clang-riscv32-sifive.dockerfile -t sifive/clang-riscv32:a3.13-r2021.06.1-n4.1 .
# if debug:
#  docker build -f clang-riscv32-sifive.dockerfile -t sifive/clang-riscv32_dbg:a3.13-r2021.06.1-n4.1 .
