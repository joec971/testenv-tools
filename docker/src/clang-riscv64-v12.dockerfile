...
# docker build -f clang-riscv64-v12.dockerfile -t sifive/clang-riscv64:a3.13-v12.0.0-n4.1a .
# if debug:
#  docker build -f clang-riscv64-v12.dockerfile -t sifive/clang-riscv64_dbg:a3.13-v12.0.0-n4.1a .
