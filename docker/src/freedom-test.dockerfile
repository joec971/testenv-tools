...
RUN apk update
RUN apk add glib pixman libgcc dtc coreutils mpfr4 xz libstdc++ ncurses libusb libusb-compat libftdi1 eudev
...
# docker export freedom-test_tmp | docker import - sifive/freedom-test:a3.13-v1.2
