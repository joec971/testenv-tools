FROM sifive/llvm-src:r2021.06.1 as clang
...
# docker build -f clang-riscv64-sifive.dockerfile -t sifive/clang-riscv64:a3.13-r2021.06.1-n4.1 .
# if debug:
#  docker build -f clang-riscv64-sifive.dockerfile -t sifive/clang-riscv64_dbg:a3.13-r2021.06.1-n4.1 .
